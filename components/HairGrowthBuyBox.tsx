...
const HairGrowthBuyBox = () => {
  ...
  const priceData = pricing.once[bottles as 2 | 4 | 6];
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <div className="text-2xl font-extrabold mb-1 break-words md:text-2xl text-xl">
                    <span className="line-through text-slate-400 text-lg mr-1">${pricing.once[n as 2 | 4 | 6].old}</span>
                    <span id={`price${n}`}>${pricing.once[n as 2 | 4 | 6].price}</span>
                  </div>
